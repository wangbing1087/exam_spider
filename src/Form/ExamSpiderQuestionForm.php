    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        if ($question_id) {
            ...
            db_insert('exam_questions')
                ->fields($values)
                ->execute();
            drupal_set_message(t('You have successfully created question for this @examSpiderExamTitle', ['@examSpiderExamTitle' => EXAM_SPIDER_EXAM_TITLE]));
        }
